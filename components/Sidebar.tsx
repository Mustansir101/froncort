...
export default function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-72 shrink-0 flex-col justify-start border-r border-zinc-100 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900">
